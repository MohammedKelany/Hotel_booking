                    ...
                    <tbody>
                        <?php foreach ($hotels as $hotel) : ?>
                            <tr>
                                ...
                                <td><a href="status-hotels.php?id=<?php echo $hotel["id"] ?>" class="btn btn-warning text-white text-center ">status</a>
                                </td>
                                <td><a href="update-hotels.php?id=<?php echo $hotel["id"] ?>" class="btn btn-warning text-white text-center ">Update
                                    </a></td>
