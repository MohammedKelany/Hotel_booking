...
if (isset($_SESSION["username"])) {
    $hotels = $roomDB->get_hotels();
    $rooms = $roomDB->get_rooms();
    $utilities = $roomDB->get_utilities();
}
?>
    ...
    <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start"
            ...
            <div class="col-md-7 ftco-animate">
                ...
                <p><a href="http://localhost/hotel-booking/about.php" class="btn btn-primary">Learn more</a> <a
                        href="http://localhost/hotel-booking/contact.php" class="btn btn-white">Contact
                        us</a></p>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-4 d-flex services align-self-stretch px-4 ftco-animate">
                <div class="d-block services-wrap text-center">
                    ...
                    <div class="media-body py-4 px-3">
                        ...
                        <p><a href="rooms.php?hotel_id=<?php echo $hotel["id"] ?>" class="btn btn-primary">View
                                rooms</a></p>
                    </div>
                </div>
            </div>
                ...
                <div class="room-wrap d-md-flex">
                    ...
                    <div class="half left-arrow d-flex align-items-center">
                        <div class="text p-4 p-xl-5 text-center">
                            ...
                            <h3 class="mb-3"><a href="rooms.html"><?php echo $room["name"] ?></a></h3>
                            ...
                            <p class="pt-1"><a href="rooms/room-single.php?room_id=<?php echo $room["id"] ?>"
                    ...
                    <div class="row">
                        ...
                        <div class="services-2 col-lg-6 d-flex w-100">
                            ...
                            <div class="media-body pl-3">
                                ...
                                <p><?php echo $utility["description"]?>
                                </p>
                            </div>
                        </div>
                        <?php endforeach; ?>
