    ...
    <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
            <div class="col-md-7 ftco-animate">
                ...
                <p><a href="http://localhost/hotel-booking/about.php" class="btn btn-primary">Learn more</a> <a href="http://localhost/hotel-booking/contact.php" class="btn btn-white">Contact
                        us</a></p>
            </div>
        </div>
    </div>
