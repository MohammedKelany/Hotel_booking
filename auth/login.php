...
<?php require __DIR__ . "/../config/databases/users_db.php"; ?>
...
if (isset($_SESSION["username"])) {
  ...
  if (isset($_POST["password"]) && isset($_POST["email"]) && $_POST["password"] && $_POST["email"]) {
    $userDB->login($_POST["password"], $_POST["email"]);
  }
}
?>
  ...
  <div class="container">
    <div class="row justify-content-middle" style="margin-left: 397px;">
      <div class="col-md-6 mt-5">
        <form method="post" action="login.php" class="appointment-form" style="margin-top: -568px;">
